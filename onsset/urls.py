...
if choice == 1:
    ...
    specs_path = r"C:\Users\renec\OneDrive\Documents\SEForALL\GitHub\InputData_OnSSET\Last_from_andreas\Specs.xlsx"
    specs = pd.read_excel(specs_path, index_col=0)

    calibrated_csv_path =\
        r"C:\Users\renec\OneDrive\Documents\SEForALL\GitHub\InputData_OnSSET\Last_from_andreas\Calibrated.csv"
