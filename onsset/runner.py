...
def calibration(specs_path, csv_path, specs_path_calib, calibrated_csv_path):
    ...
    onsseter.df[SET_GRID_PENALTY] = onsseter.grid_penalties(onsseter.df, land_cover_dict)
    ...
    onsseter.project_pop_and_urban(pop_modelled, pop_future, urban_modelled,
                                   urban_future, start_year, [intermediate_year, end_year])
...
def scenario(specs_path, calibrated_csv_path, results_folder, summary_folder, pv_path, wind_path):
    ...
    for scenario in scenarios:
        ...
        rural_tier_small = int(scenario_parameters.iloc[tier_index]['RuralSmallTargetTier'])
        ...
        # RUN_PARAM: Fill in general and 8ology specific parameters (e.g. discount rate, losses etc.)
        ...
        for year in yearsofanalysis:
            ...
            onsseter.set_scenario_variables(year, num_people_per_hh_rural, num_people_per_hh_urban, time_step,
                                            start_year, urban_tier, rural_tier, rural_tier_small, productive_demand,
                                            small_rural_threshold)
            ...
            sa_diesel_investment, sa_pv_investment, mg_hydro_investment = \
                onsseter.calculate_off_grid_lcoes(mg_hydro_calc, sa_pv_calc, sa_diesel_calc, year, end_year, time_step)
            ...
            onsseter.calculate_investments(sa_diesel_investment, sa_pv_investment,
